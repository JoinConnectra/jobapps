// src/app/university/dashboard/inbox/_components/ConversationList.tsx
'use client';
              ...
              >
                <div className="flex items-start gap-2">
                  ...
                  >
                    ...
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md border bg-white text-xs font-medium">
