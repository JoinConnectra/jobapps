            ...
            <div className="bg-white rounded-lg shadow-sm p-5 mb-6">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <Button variant={activeTab === "details" ? "default" : "outline"} size="sm" onClick={() => setActiveTab("details")}>
                    Details
                  </Button>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-lg shadow-sm p-5">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <h3 className="text-base font-medium text-gray-900">Add Question</h3>
                      <p className="text-xs text-gray-500">MCQ, short, coding or case</p>
                    </div>
                    <Button size="sm" onClick={addQuestion} disabled={creating}>
                              ...
                              {mcqOptions
                                ...
                                .map((o) => (
                                  <li key={o}>
                                    ...
                                    <span className={o === mcqCorrect ? "font-semibold" : ""}>
                                      {o} {o === mcqCorrect ? "(correct)" : ""}
                                    </span>
                                  </li>
                                ))}
                            </ul>
...
{starterCode || "// starter code"}
                ...
                <div className="bg-white rounded-lg shadow-sm p-5">
                  {loadingQs ? (
                    ...
                    <div className="py-8 text-sm text-gray-600">
                      No questions yet. Use <span className="font-medium">“Save question”</span> above to create one.
                    </div>
                  ) : (
                    <div className="space-y-3">
                      {questions.map((q) => (
      ...
      <CommandPalette isOpen={isCommandPaletteOpen} onClose={() => {}} orgId={org?.id} />
    </div>
  );
}
